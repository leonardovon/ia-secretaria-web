...
const Header = () => {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-sm border-b border-primary/10 shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-2xl font-bold text-primary">IA Secretária</div>
          </div>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <nav className="md:hidden pb-4 border-t border-primary/10 pt-4">
